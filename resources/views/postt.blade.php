    ...
    <div class="row justify-content-center mb-5">
        <div class="col-md-8">
            ...
            <p>
                ...
                By. <a href="/authors/{{ $post->author->username }}" class="text-decoration-none">{{ $post->author->name }}</a> {{ $posts->created_at->diffForHumans() }}
                </small>
            </p>
...
@if ($post->count())
    <div class="card mb-3">
        ...
        <h3 class="card-title"><a href="">{{ $posts[0]->slug }} class="text-decoration-none text-dark"></a></h3>
        <p>
        <small class="text-muted">
        ...
        <a href="/postt/{{ $post[0]->slug }}" class="text-decoration-none btn btn-primary">Read more</a>

        </div>

    <div class="container">
        <div class="row">
            @foreach ($posts->skip(1) as postt )
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <a href="/postt/{{ $post->slug }}" class="btn btn-primary">Read more</a>
                    </div>
                  </div>
                  @endforeach
            </div>
